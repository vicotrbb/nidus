...
```toml
nidus = { package = "nidus-rs", version = "1.0.5", features = ["http", "config"] }
nidus-sqlx = { version = "1.0.5", features = ["sqlite", "observability"] }
```
...
```toml
nidus = { package = "nidus-rs", version = "1.0.5" }
nidus-cache = { version = "1.0.5", features = ["moka", "observability"] }
```
...
```toml
nidus = { package = "nidus-rs", version = "1.0.5", features = ["http", "config"] }
nidus-sqlx = { version = "1.0.5", features = ["postgres"] }
```
