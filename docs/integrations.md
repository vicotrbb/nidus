...
```toml
nidus = { package = "nidus-rs", version = "1.0.16", features = ["http", "config"] }
nidus-integrations = "1.0.16"
nidus-redis = { version = "1.0.16", features = ["health", "observability"] }
nidus-kafka = { version = "1.0.16", features = ["health", "observability"] }
```
