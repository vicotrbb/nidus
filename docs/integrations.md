...
nidus-sqlx = { version = "1.0.8", features = ["sqlite", "observability"] }
```
...
```toml
nidus = { package = "nidus-rs", version = "1.0.8" }
nidus-cache = { version = "1.0.8", features = ["moka", "observability"] }
```
...
```toml
nidus = { package = "nidus-rs", version = "1.0.8", features = ["http", "config"] }
nidus-sqlx = { version = "1.0.8", features = ["postgres"] }
```
