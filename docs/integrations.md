...
nidus-sqlx = { version = "1.0.9", features = ["sqlite", "observability"] }
```
...
```toml
nidus = { package = "nidus-rs", version = "1.0.9" }
nidus-cache = { version = "1.0.9", features = ["moka", "observability"] }
```
...
```toml
nidus = { package = "nidus-rs", version = "1.0.9", features = ["http", "config"] }
nidus-sqlx = { version = "1.0.9", features = ["postgres"] }
```
