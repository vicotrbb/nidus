...
```toml
nidus = { package = "nidus-rs", version = "1.0.6", features = ["http", "config"] }
nidus-sqlx = { version = "1.0.6", features = ["sqlite", "observability"] }
```
...
```toml
nidus = { package = "nidus-rs", version = "1.0.6" }
nidus-cache = { version = "1.0.6", features = ["moka", "observability"] }
```
...
```toml
nidus = { package = "nidus-rs", version = "1.0.6", features = ["http", "config"] }
nidus-sqlx = { version = "1.0.6", features = ["postgres"] }
```
