...
```toml
nidus = { package = "nidus-rs", version = "1.0.4", features = ["http", "config"] }
nidus-sqlx = { version = "1.0.4", features = ["sqlite", "observability"] }
```
...
```toml
nidus = { package = "nidus-rs", version = "1.0.4" }
nidus-cache = { version = "1.0.4", features = ["moka", "observability"] }
```
...
```toml
nidus = { package = "nidus-rs", version = "1.0.4", features = ["http", "config"] }
nidus-sqlx = { version = "1.0.4", features = ["postgres"] }
```
