...
```toml
nidus = { package = "nidus-rs", version = "1.1.0", features = ["http", "config"] }
nidus-integrations = "1.1.0"
nidus-redis = { version = "1.1.0", features = ["health", "observability"] }
nidus-kafka = { version = "1.1.0", features = ["health", "observability"] }
```
