...
const docs = [
  ...
  },
  {
    ...
    slug: 'docs/release-1-0-17',
    group: 'Reference',
    source: 'docs/release-1-0-17.md',
    summary: 'Nidus 1.0.17 quickstart, CLI graph, dependency security, and scheduled policy hardening.',
  },
  {
  ...
  },
  {
    ...
    slug: 'docs/release-1-0-15',
    group: 'Reference',
    source: 'docs/release-1-0-15.md',
    summary: 'Nidus 1.0.15 dependency, CI action, macro compatibility, and security-scanning maintenance.',
  },
  {
    title: 'Release 1.0.14',
    slug: 'docs/release-1-0-14',
    group: 'Reference',
    source: 'docs/release-1-0-14.md',
    summary: 'Nidus 1.0.14 typed-configuration and lifecycle-startup allocation improvements.',
  },
  {
    title: 'Release 1.0.13',
    slug: 'docs/release-1-0-13',
    group: 'Reference',
    source: 'docs/release-1-0-13.md',
    summary: 'Nidus 1.0.13 DI, health, event, middleware, logging, HTTP semantics, and CLI quality improvements.',
  },
  {
